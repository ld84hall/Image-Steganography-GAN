...
for file in os.listdir("cifar100_png/test"):
	...
	print("working")
	path = os.path.join("cifar100_png/test", file)
	image = cv2.imread(path)
	height, width = image.shape[:2]
	randnum2 = random.randint(1,2)
	toembed = "0110100001100101011011000110110001101111"
	...
	if randnum2 == 1:
		...
		output = name +".png"
		print(output)
		cv2.imwrite(os.path.join("images4/test/stegs", output), stego)
	else:
		name = os.path.splitext(file)[0]
		output = name +".png"
		print(output)
		cv2.imwrite(os.path.join("images4/test/covers", output), image)
